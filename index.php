        ...
        <div class="auth-container">
            ...
            <div class="form-container hidden" id="registerForm">
                ...
                <form class="auth-form">
                    ...
                    <small class="input-hint" id="passwordHint">Use pelo menos 6 caracteres (dica: combine maiúsculas, números e símbolos).</small>
                    ...
                    <small class="input-hint mismatch hidden" id="passwordMismatch">As senhas não coincidem.</small>
